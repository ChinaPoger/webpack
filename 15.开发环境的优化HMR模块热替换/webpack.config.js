...
const { LoaderOptionsPlugin, web } = require('webpack');
...
//https://www.cnblogs.com/tugenhua0707/p/9418526.html 参数的定义
  devServer:{
    ...
    compress:true,
    //HMR模块热更新  
    //css文件一定要使用style-loader css-loader
    //html文件需要把入口html文件 加到webpack.config.js的entry
    //js文件 入口文件肯定会更新 其他js要在入口js添加如下代码
  //   if (module.hot) {
